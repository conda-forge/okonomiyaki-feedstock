...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/okonomiyaki-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6642&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/okonomiyaki-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `okonomiyaki` can be installed with:

```
conda install okonomiyaki
```

It is possible to list all of the versions of `okonomiyaki` available on your platform with:
